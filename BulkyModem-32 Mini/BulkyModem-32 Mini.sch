...
Wire Wire Line
	4800 3350 5100 3350
Text GLabel 9275 5175 2    50   Output ~ 0
ESP_TX
$Comp
L 74xx:74HCT244 U1
U 1 1 62F8565C
...
F 0 "U6" H 8825 5500 50  0000 C CNN
F 1 "74HCT32" H 8825 5409 50  0000 C CNN
F 2 "" H 8825 5175 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74LS32" H 8825 5175 50  0001 C CNN
	1    8825 5175
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 6462A6AE
P 8050 5275
F 0 "#PWR010" H 8050 5025 50  0001 C CNN
F 1 "GND" H 8055 5102 50  0000 C CNN
...
F 0 "JP16" H 8800 5811 31  0000 C CNN
F 1 "BYPASS" H 8800 5749 31  0000 C CNN
F 2 "Jumper:SolderJumper-2_P1.3mm_Open_Pad1.0x1.5mm" H 8800 5650 50  0001 C CNN
...
F 0 "R18" H 8650 3650 50  0000 R CNN
F 1 "10k*" H 8650 3575 50  0000 R CNN
F 2 "resistor:R_Axial_DIN0207_L6.3mm_D2.5mm_P10.16mm_Horizontal" V 8655 3625 50  0001 C CNN
...
ESP_CTS
Text GLabel 9325 3850 2    50   Input ~ 0
ESP_RX
...
F 0 "JP15" V 8200 5000 50  0000 R CNN
F 1 "TX_FILTER" V 8125 5000 50  0000 R CNN
F 2 "Jumper:SolderJumper-3_P1.3mm_Open_RoundedPad1.0x1.5mm" H 8050 5075 50  0001 C CNN
...
U 1 1 66484B65
P 8725 3475
F 0 "#PWR0123" H 8725 3325 50  0001 C CNN
F 1 "+3.3V" H 8740 3648 50  0000 C CNN
...
U 1 1 66487BB5
P 9100 3850
F 0 "D14" H 9100 3633 50  0000 C CNN
F 1 "1N4148" H 9100 3724 50  0000 C CNN
F 2 "Diode_THT:D_DO-35_SOD27_P7.62mm_Horizontal" H 9100 3675 50  0001 C CNN
F 3 "https://assets.nexperia.com/documents/data-sheet/1N4148_1N4448.pdf" H 9100 3850 50  0001 C CNN
	1    9100 3850
	-1   0    0    1   
$EndComp
Wire Wire Line
...
* Install R18 if noise is encountered,\notherwise leave unpopulated.
$Comp
